...
import { formatPrice, getCheckoutPrice } from '@/lib/products'
          ...
          <div className="mt-14 grid grid-cols-1 gap-14 lg:grid-cols-12">
            ...
            <ul className="lg:col-span-7 xl:col-span-8">
              <AnimatePresence initial={false}>
                {items.map((item) => {
                  const unitPrice = getCheckoutPrice(item.product)
                  return (
                    <motion.li
...
//this file is C:\Users\HP\salami\salami-app\components\cart-view.tsx